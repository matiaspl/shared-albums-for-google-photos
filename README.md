...
- Multiple display modes — single-photo slider, carousel (multi-photo preview that opens single-photo fullscreen), or thumbnail grid (with optional `grid-rows` paging/scrolling)
